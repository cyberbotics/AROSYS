#!/bin/bash
#
# Start-Stop-Hooks for component ComponentLaserObstacleAvoidTest
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentLaserObstacleAvoidTest.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentLaserObstacleAvoidTest.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentLaserObstacleAvoidTest.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentLaserObstacleAvoidTest.sh post-stop

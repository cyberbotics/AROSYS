#!/bin/bash
#
# This script is run prior to deployment of component ComponentWebotsRobotino3
...
source $REFERENCED_PROJECT_ComponentWebotsRobotino3/smartsoft/src/predeploy.sh

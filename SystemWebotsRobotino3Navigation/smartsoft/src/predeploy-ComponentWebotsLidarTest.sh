#!/bin/bash
#
# This script is run prior to deployment of component ComponentWebotsLidarTest
...
source $REFERENCED_PROJECT_ComponentWebotsLidarTest/smartsoft/src/predeploy.sh

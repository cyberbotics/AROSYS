...
#ifndef COMPONENTWEBOTSROBOTINO3_OPC_UA_BACKEND_PORTFACTORY_HH_
#define COMPONENTWEBOTSROBOTINO3_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class ComponentWebotsRobotino3OpcUaBackendPortFactory: public ComponentWebotsRobotino3PortFactoryInterface
{
private:
	...
	int task_execution();
public:
	ComponentWebotsRobotino3OpcUaBackendPortFactory();
	virtual ~ComponentWebotsRobotino3OpcUaBackendPortFactory();
...
#endif /* COMPONENTWEBOTSROBOTINO3_SERONET_SDK_PORTFACTORY_HH_ */

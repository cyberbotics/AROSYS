...
//--------------------------------------------------------------------------
#ifndef _ROBOTINO3TASK_CORE_HH
#define _ROBOTINO3TASK_CORE_HH
...
#include <Robotino3TaskObserverInterface.hh>


class Robotino3TaskCore
...
private:
	...
	std::list<Robotino3TaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(Robotino3TaskObserverInterface *observer);
	void detach_interaction_observer(Robotino3TaskObserverInterface *observer);

public:
	Robotino3TaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~Robotino3TaskCore();

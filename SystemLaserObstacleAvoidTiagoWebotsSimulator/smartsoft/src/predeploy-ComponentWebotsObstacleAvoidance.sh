#!/bin/bash
#
# This script is run prior to deployment of component ComponentWebotsObstacleAvoidance
...
source $REFERENCED_PROJECT_ComponentWebotsObstacleAvoidance/smartsoft/src/predeploy.sh

#!/bin/bash
#
# Start-Stop-Hooks for component ComponentWebotsObstacleAvoidance
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebotsObstacleAvoidance.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsObstacleAvoidance.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsObstacleAvoidance.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsObstacleAvoidance.sh post-stop

#!/bin/bash
#
# Start-Stop-Hooks for component ComponentTCLSequencer
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentTCLSequencer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentTCLSequencer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentTCLSequencer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentTCLSequencer.sh post-stop

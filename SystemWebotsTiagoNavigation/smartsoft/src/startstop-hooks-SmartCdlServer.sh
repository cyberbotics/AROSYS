#!/bin/bash
#
# Start-Stop-Hooks for component SmartCdlServer
#
...
pre-start)
	...
	bash startstop-hooks-component-SmartCdlServer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartCdlServer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartCdlServer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartCdlServer.sh post-stop

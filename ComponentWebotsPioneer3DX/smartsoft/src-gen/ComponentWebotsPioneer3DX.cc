...
ComponentWebotsPioneer3DX* ComponentWebotsPioneer3DX::_componentWebotsPioneer3DX = 0;

// constructor
ComponentWebotsPioneer3DX::ComponentWebotsPioneer3DX()
{
	std::cout << "constructor of ComponentWebotsPioneer3DX\n";
	...
	//componentWebotsPioneer3DXParams = NULL;
	...
	connections.component.name = "ComponentWebotsPioneer3DX";
	...
	// initialize members of ComponentWebotsPioneer3DXROSExtension
	
	// initialize members of OpcUaBackendComponentGeneratorExtension
	
	// initialize members of PlainOpcUaComponentWebotsPioneer3DXExtension
	
}

void ComponentWebotsPioneer3DX::addPortFactory(const std::string &name, ComponentWebotsPioneer3DXPortFactoryInterface *portFactory)
{
	portFactoryRegistry[name] = portFactory;
}

void ComponentWebotsPioneer3DX::addExtension(ComponentWebotsPioneer3DXExtension *extension)
{
	componentExtensionRegistry[extension->getName()] = extension;
}

SmartACE::SmartComponent* ComponentWebotsPioneer3DX::getComponentImpl()
{
	return dynamic_cast<ComponentWebotsPioneer3DXAcePortFactory*>(portFactoryRegistry["ACE_SmartSoft"])->getComponentImpl();
}
 ...
 */
void ComponentWebotsPioneer3DX::setStartupFinished() {
 ...
 */
Smart::StatusCode ComponentWebotsPioneer3DX::connectAndStartAllServices() {
 ...
 */
void ComponentWebotsPioneer3DX::startAllTasks() {
 ...
 */
void ComponentWebotsPioneer3DX::startAllTimers() {
}


Smart::TaskTriggerSubject* ComponentWebotsPioneer3DX::getInputTaskTriggerFromString(const std::string &client)
{
...
void ComponentWebotsPioneer3DX::init(int argc, char *argv[])
{
	try {
		...
		// initializations of ComponentWebotsPioneer3DXROSExtension
		
		// initializations of OpcUaBackendComponentGeneratorExtension
		
		// initializations of PlainOpcUaComponentWebotsPioneer3DXExtension
		...
		ComponentWebotsPioneer3DXPortFactoryInterface *acePortFactory = portFactoryRegistry["ACE_SmartSoft"];
		if(acePortFactory == 0) {
		...
		SmartACE::SmartComponent *component = dynamic_cast<ComponentWebotsPioneer3DXAcePortFactory*>(acePortFactory)->getComponentImpl();
		
		std::cout << "ComponentDefinition ComponentWebotsPioneer3DX is named " << connections.component.name << std::endl;
...
// run the component
void ComponentWebotsPioneer3DX::run()
{
...
void ComponentWebotsPioneer3DX::fini()
{
	...
	// destruction of ComponentWebotsPioneer3DXROSExtension
	
	// destruction of OpcUaBackendComponentGeneratorExtension
	
	// destruction of PlainOpcUaComponentWebotsPioneer3DXExtension
	
}

void ComponentWebotsPioneer3DX::loadParameter(int argc, char *argv[])
{
	/*
	...
	try
	{
		...
		} else if(parameter.searchFile("ComponentWebotsPioneer3DX.ini", parameterfile)) {
			parameterFileFound = true;
			std::cout << "load ComponentWebotsPioneer3DX.ini parameter file\n";
			parameter.addFile(parameterfile);
		} else {
			std::cout << "WARNING: ComponentWebotsPioneer3DX.ini parameter file not found! (using default values or command line arguments)\n";
		}
		...
		// load parameters for ComponentWebotsPioneer3DXROSExtension
		
		// load parameters for OpcUaBackendComponentGeneratorExtension
		
		// load parameters for PlainOpcUaComponentWebotsPioneer3DXExtension

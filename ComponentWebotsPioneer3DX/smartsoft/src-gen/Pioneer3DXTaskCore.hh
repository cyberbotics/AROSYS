...
//--------------------------------------------------------------------------
#ifndef _PIONEER3DXTASK_CORE_HH
#define _PIONEER3DXTASK_CORE_HH
...
#include <Pioneer3DXTaskObserverInterface.hh>


class Pioneer3DXTaskCore
...
private:
	...
	std::list<Pioneer3DXTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(Pioneer3DXTaskObserverInterface *observer);
	void detach_interaction_observer(Pioneer3DXTaskObserverInterface *observer);

public:
	Pioneer3DXTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~Pioneer3DXTaskCore();

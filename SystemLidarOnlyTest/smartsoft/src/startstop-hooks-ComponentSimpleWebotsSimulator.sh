#!/bin/bash
#
# Start-Stop-Hooks for component ComponentSimpleWebotsSimulator
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentSimpleWebotsSimulator.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSimpleWebotsSimulator.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSimpleWebotsSimulator.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSimpleWebotsSimulator.sh post-stop

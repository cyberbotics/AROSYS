#!/bin/bash
#
# This script is run prior to deployment of component ComponentLaserObstacleAvoidTest
...
source $REFERENCED_PROJECT_ComponentLaserObstacleAvoidTest/smartsoft/src/predeploy.sh

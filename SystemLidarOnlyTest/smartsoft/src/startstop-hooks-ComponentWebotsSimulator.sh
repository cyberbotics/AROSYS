#!/bin/bash
#
# Start-Stop-Hooks for component ComponentWebotsSimulator
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebotsSimulator.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsSimulator.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsSimulator.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsSimulator.sh post-stop

#!/bin/bash
#
# This script is run prior to deployment of component ComponentSimpleWebotsSimulator
...
source $REFERENCED_PROJECT_ComponentSimpleWebotsSimulator/smartsoft/src/predeploy.sh

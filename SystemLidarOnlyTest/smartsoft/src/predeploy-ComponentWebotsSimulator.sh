#!/bin/bash
#
# This script is run prior to deployment of component ComponentWebotsSimulator
...
source $REFERENCED_PROJECT_ComponentWebotsSimulator/smartsoft/src/predeploy.sh
